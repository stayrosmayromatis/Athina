...
public class Stoixeia_Grammateia extends javax.swing.JInternalFrame {
    ...
    public void loadDefaultValues(Model.Grammateia grammateia)
    {
        name.setText(grammateia.getUsername());
        email.setText(grammateia.getEmail());
    }
    
    public Stoixeia_Grammateia(Model.Grammateia grammateia) {
        initComponents();
        this.loadDefaultValues(grammateia);   
    }
